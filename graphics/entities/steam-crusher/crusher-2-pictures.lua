...
function crusher_animation_horizontal_main()
  return util.sprite_load("__muluna-graphics__/graphics/entities/steam-crusher/crusher-2-horizontal",
  {
    animation_speed = 0.5,
    frame_count = 48,
    scale = 0.5,
...
function crusher_animation_vertical_main()
  return util.sprite_load("__muluna-graphics__/graphics/entities/steam-crusher/crusher-2-vertical",
  {
    animation_speed = 0.5,
    frame_count = 48,
    scale = 0.5,
